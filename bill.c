 ...
 */
static int letter1(long gold)
{

  lstandout("From:"); lprcat("  the LRS (Larn Revenue Service)\n");
  ...
  lprintf("\nin preparing your tax bill.  You owe %d gold pieces as", gold * TAXRATE);
...
static int letter2(void)
{
  ...
  lstandout("From:"); lprcat("  His Majesty King Wilfred of Larndom\n");
...
static int letter3(void)
{
  lstandout("From:"); lprcat("  Count Endelford\n");
...
static int letter4(void)
{
  lstandout("From:"); lprcat("  Mainair, Duke of Larnty\n");
...
static int letter5(void)
{
  lstandout("From:"); lprcat("  St. Mary's Children's Home\n");
...
static int letter6(void)
{
  lstandout("From:"); lprcat("  The National Cancer Society of Larn\n");
  lstandout("\nSubject:"); lprcat("  hope\n");
