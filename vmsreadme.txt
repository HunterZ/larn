This is a VMS version of LARN 12.2.  To run it, larndir must be defined as a 
...
a symbol or logical called "terminal" then the value of that will
be used for the terminal, otherwise the value from "term" will be
used.
...
re-work it, this will have to do.  Customization is not currently supported.  
